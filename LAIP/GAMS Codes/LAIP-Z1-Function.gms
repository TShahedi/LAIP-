...
objective.. Z1 =e=sum((i,j,t),TC(i,j,t)*Beta(i,j,t)*(1+zi(t)))+
...
Model LAIP /ALL/ ;
 solve LAIP using MINLP minimizing Z1;
 LAIP.optcr=0;
 display  Z1.l,Miup.l,Miud.l,Sigma2p.l,Sigma2d.l,II.l,B.l,HH.l,Hs.l,rr.l,bb.l,Beta.l,F.l,Q.l,Qs.l,ZZ.l,w.l,x.l,y.l,v.l;

...
objective..   Z2=e=sum((i,j,t),EIS(i,j,t)*Beta(i,j,t))+sum((j,k,t),EIP(j,k,t)*F(j,k,t))+
...
Model LAIP /ALL/ ;
 solve LAIP using MINLP minimizing Z2;
 LAIP.optcr=0;
 option optcr=0,optca=0;
 display  Z2.l,Miup.l,Miud.l,Sigma2d.l,Sigma2p.l,II.l,B.l,HH.l,Hs.l,rr.l,bb.l,Beta.l,F.l,Q.l,Qs.l,ZZ.l,w.l,x.l,y.l,v.l;
